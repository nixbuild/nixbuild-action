...
function derivationToColumn(b) {
  ...
  return `<details style="margin:0"><summary>${drvName}</summary><pre>build id: ${b.build_id.toString()}<br/>start time: ${b.start_time}<br/>deriver: ${b.derivation_path}<br/>outputs:${outputs}</pre></details>`;
}
